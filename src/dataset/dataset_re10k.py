    ...
    def __iter__(self):
        ...
        for chunk_path in self.chunks:
            ...
            for example in chunk:
                ...
                context_indices = context_indices.tolist() + target_indices.tolist()
                target_indices = torch.Tensor(sorted(context_indices)).long()
                context_indices = torch.Tensor(sorted(context_indices)).long()
                # Load the images.
                context_images = [
